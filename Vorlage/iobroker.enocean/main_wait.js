...
const RadioTelegram_ERP2 = require('./lib/tools/ESP3Packet').RadioTelegram_ERP2;
	...
	async parseMessage(data) {
		...
		switch (esp3packet.type) {
			...
			case 10: //RADIO_ERP2
				...
				const esp2packet = new RadioTelegram_ERP2(data);

				this.log.debug('ERP2 protocol radio telegram received.');
				this.log.debug('Packet type 2 received: ' + JSON.stringify(esp2packet.senderID));
				break;
